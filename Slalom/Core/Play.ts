class Play {
    ...
    private flagInterval: number;
    private showDebug : boolean ;
    private land: Phaser.Group;
    private player: Phaser.Sprite;
    private pauseKey: Phaser.Key;
    private debugKey: Phaser.Key;
    private skis: Phaser.Sprite;
    ...
    checkCollision(player, item) : boolean{
